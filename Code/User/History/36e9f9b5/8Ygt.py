from app.contracts import ScheduleInput, ScheduleOutput, RecipientDetail, RecipientSchedule, Date_validator
    ...
    def schedule(self, input: ScheduleInput) -> ScheduleOutput:
        ...
        for index, recipient_id in enumerate(input.recipients):
            ...
            for week_schedule in input.schedule:
                ...
                schedule_time = datetime.combine(Date_validator(input_date=date), week_schedule.start_time) + timedelta(minutes=5 * index)
